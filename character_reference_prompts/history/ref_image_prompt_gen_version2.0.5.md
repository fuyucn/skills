...
description: |
  ...
  包含面部融合口诀，确保人物在新场景中自然融合而非拼贴感。
  自动注入艺术签名 "hypn"。
---

# ref_image_prompt_gen_version2.0.5.md
...
14. **（2.0.5 新增）** 身份陈述使用"同一人在新场景"语气（选项 A），而非"贴脸"语气。
15. **（2.0.5 新增）** 面部与身体的受光方向、色温、阴影密度、皮肤质感描述一致，无拼贴感。
