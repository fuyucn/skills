...
- **不支持写实真人脸部素材**：上传含清晰可辨识真人面孔的图片或视频会被平台自动拦截。使用角色卡或风格化人物参考代替真人照片。
- **延长视频时生成时长选「新增部分」**：延长5秒就选5秒，不是选原视频+5秒的总时长。
- **@引用必须明确用途**：只写「参考@视频1」导致模型随机选择，必须说明参考运镜/动作/特效/节奏。
- **亲密场景审核相对宽松**：相比 Grok，Seedance 对首尾帧控制的亲密场景限制更少，配合「@图1作为首帧，@图2作为尾帧」可精确控制场景边界。
...
> 来源：[dexhunter/seedance2-skill](https://github.com/dexhunter/seedance2-skill)（中文版）
> 集成时间：2026-05-25
