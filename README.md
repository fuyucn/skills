...
| [character-reference-prompts](./character_reference_prompts/) | 参考图人物生图提示词完整规范（2.0.8 + 全部历史版本） |
...
| [prompt-formatter](./prompt-formatter/) | AI 提示词格式优化器——诊断 + 重构，节省 token，提升关键约束权重 |
